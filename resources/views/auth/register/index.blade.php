                    ...
                    data-then="alert">
                        <div class="row gy-4">
                            ...
                            <label for="phone">Title</label>
                                <div class="single-input white-bg">
                                    <select name="title" id="title" style="border: none; padding: 10px 25px; box-shadow: none; line-height: 30px; transition: all 0.3s linear;" class="form-control single-input white-bg" required>
                                        <option></option>
                                            <x-title-options />
                                    </select>
                                </div>
