                                                ...
                                                <div class="schedule-content-wrap">
                                                    <div class="schedule-content">
                                                        ...
                                                        <div class="schedule-descrip">
                                                            <img src="{{ cloudinary_url('imt/gallery/thumb_m9sran') }}" width="80" alt="Thumbnail" id="collapseContent1" class="schedule-thumb-img">
                                                            <img src="{{ cloudinary_url('imt/gallery/thumb_m9sran') }}" width="80" alt="Thumbnail" id="collapseContent1" class="schedule-thumb-img">
                                                            <img src="{{ cloudinary_url('imt/gallery/thumb_m9sran') }}" width="80" alt="Thumbnail" id="collapseContent1" class="schedule-thumb-img">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-9 col-12">
                                                <div class="schedule-content-wrap">
                                                    <div class="schedule-content">
                                                        ...
                                                        <h4 class="schedule-title">Decoupling policy bottlenecks hindering collaborative innovation
                                                            in insurance</h4>
                                                        <div class="schedule-descrip">
                                                            <img src="{{ cloudinary_url('imt/gallery/thumb_m9sran') }}" width="80" alt="Thumbnail" class="schedule-thumb-img">
                                                            <img src="{{ cloudinary_url('imt/gallery/thumb_m9sran') }}" width="80" alt="Thumbnail" class="schedule-thumb-img">
                                                            <p class="collapse hidden-desc" id="plenary_1">• Pre-panel Presentation</p>
                                                            <p class="collapse hidden-desc" id="plenary_1">• Discourse
                                                            </p>
                                                            <p class="collapse hidden-desc" id="plenary_1">• Question
                                                                and Answers</p>
                                                            <p class="collapse hidden-desc" id="plenary_1">• Photo
                                                                session</p>
                                                        </div>
                                                    </div>
                                                    <a class="minus-btn" data-bs-toggle="collapse" href="#plenary_1" role="button" aria-expanded="false" aria-controls="collapseContent2">
                                                        <div class="plus-icon-2">
                                                            <div class="plus-icon-shape"></div>
                                                        </div>
                                                    </a>
                                            ...
                                            <div class="col-lg-9 col-12">
                                                <div class="schedule-content-wrap">
                                                    <div class="schedule-content">
                                                        ...
                                                        <h4 class="schedule-title">Plenary 2</h4>
                                                        ...
                                                        width="80" alt="Thumbnail" class="schedule-thumb-img">
                                                        <img src="{{ cloudinary_url('imt/gallery/thumb_m9sran') }}"
                                                        width="80" alt="Thumbnail" class="schedule-thumb-img">
                                                            <p class="collapse hidden-desc" id="plenary_2">• Discourse
                                                            </p>
                                                            <p class="collapse hidden-desc" id="plenary_2">• Question
                                                                and Answers</p>
                                                            <p class="collapse hidden-desc" id="plenary_2">• Photo
                                                                session</p>
                                                        </div>
                                                    </div>
                                                    <a class="minus-btn" data-bs-toggle="collapse" href="#plenary_2"
                                                        role="button" aria-expanded="false"
                                                        aria-controls="plenary_2">
                                                        <div class="plus-icon-2">
                                                            <div class="plus-icon-shape"></div>
                                                        </div>
                                                    </a>
        ...
        <div class="container">
            ...
            <div class="row g-0">
                <div class="col-md-3 col-sm-6">
                    <a href="javascript:void()" class="single-gallery">
