...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="heading mb-0">Speakers</h4>
                                            ...
                                            <tbody>
                                                @forelse ($speakers as $speaker)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset("speaker/$speaker->image") }}" class="avatar rounded-circle" alt="">
                                                                <p class="mb-0 ms-2">{{ $speaker->name }}</p>
                                                            </div>
                                                        </td>
        ...
        <div class="modal-dialog modal-dialog-center modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel1">Create Speaker</h1>
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-center modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel1">Update Speaker</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
