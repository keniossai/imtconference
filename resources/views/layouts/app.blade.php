                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="dropdown nav-item active show">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a target="_blank" href="{{ asset('Agc-sport-events.pdf') }}">Sports</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown nav-item active show">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a target="_blank" href="{{ asset('Hotels.pdf') }}">Hotel</a></li>
                                    <li><a target="_blank" href="{{ asset('Flight-Schedule.pdf') }}">Flight</a></li>
                            ...
                            <li class="dropdown nav-item active show">
                                <a href="javascript:void(0)" class="" data-toggle="dropdown"
                                    aria-expanded="true">Exhibition<i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu">

                                    <li><a target="_blank"
                                            href="{{ asset('exhibition_information.pdf') }} ">Exhibition
                                            Information</a></li>
                                    <li><a target="_blank" href="{{ route('home.exhibition') }}">Exhibitors Form</a>
                                    </li>
                            ...
                            <li class="dropdown nav-item active show">
                                <a href="javascript:void(0)" class="" data-toggle="dropdown"
                                    aria-expanded="true">Quick Links<i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu">

                                    <li><a target="_blank"
                                            href="{{ asset('document/nba_agc_2023_faqs.pdf') }}">FAQs</a>
                                    </li>
                                    <li><a class="ql d-flex" target="_blank" href="#"
                                            style="white-space:nowrap; ">Friendship Center
                                            Information
                                            <div class="soon-btn"
                                                style="background-color:rgba(255, 0, 0, 0.616); color:white; display:flex; align-items:center; justify-content:center; padding:3px; border-radius:10px; font-size:12px;">
                                                Coming soon...</div>
                                        </a>
                                    </li>
                                    <li><a target="_blank" href="https://www.nigerianbar.org.ng/">NBA</a>
                                    </li>
                            ...
                            @auth
                                <li class="dropdown nav-item active show">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        @nba
                                        <li><a href="{{ route('dashboard.nba') }}">Dashboard</a></li>
                                        @endnba
                                        @admin
                            ...
                            @else
                                ...
                                <li class="header-ticket nav-item">
                                    <a style="background-color: #7D4D65;" class="ticket-btn btn"
                ...
                if (!localStorage.hotels) {
                    setTimeout(() => {
                        swal({
                            ...
                            text: "Flight and Accommodation information now available",
                            icon: "info",
                            buttons: ["Cancel", "Show me...", "Flights"]
                        }).then((confirm) => {
                            if (confirm) {

                                //location.href = "{{ asset('Hotels.pdf') }}";
                                window.open(
                                    '{{ asset('Hotels.pdf') }}',
