                                ...
                                <div class="navbar-collapse collapse scroll-nav clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="#events">Events</a>
                                            <ul>
                                                <li><a target="_blank"
                                                        href="{{ asset('Agc-sport-events.pdf') }}">Sports</a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                ...
                                                <li class=""><a href="https://www.nigerianbar.org.ng/"
                                                        target="_blank">NBA</a></li>

                                                <li class="d-flex ql" style="white-space:nowrap; ">
                                                    <a target="_blank" href="">Friendship Center
                                                        Information</a>
                                                    <div class="soon-btn"
                                                        style="background-color:rgba(255, 0, 0, 0.616); color:white; display:flex; align-items:center; justify-content:center; padding:3px; border-radius:10px; font-size:12px; margin-left:6px;">
                                                        Coming soon...</div>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="dropdown"><a href="{{ route('speakers.index') }}">Speakers</a></li>
                                        <li class="dropdown"><a href="#">Hotel/Travel</a>
                                            <ul>
                                                <li><a target="_blank" href="{{ asset('Hotels.pdf') }}">Hotel</a></li>
                                                <li><a target="_blank"
                                                        href="{{ asset('Flight-Schedule.pdf') }}">Flight</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                <li><a target="_blank"
                                                        ...
                                                        Information</a></li>
                                                <li><a target="_blank" href="{{ route('home.exhibition') }}">Exhibitors
                                                        Form</a></li>
                                            </ul>
                                        </li>
